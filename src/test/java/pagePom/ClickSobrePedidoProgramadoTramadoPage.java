...
public class ClickSobrePedidoProgramadoTramadoPage extends Base {
	...
	By btnNuevaPropuestaLocator = By.id("//*[@id=\\\"programador-main\\\"]/div[1]/div[3]/div[1]/button[3]"); 
	
	
	//Locator fondo verde tramado
	By clickSobrePedidoProgramado = By.xpath("//*[@id=\"programador-main\"]/div[1]/div[3]/div[1]/button[3]");

	
	
	
	
	public ClickSobrePedidoProgramadoTramadoPage(WebDriver driver) {
		super(driver);
...
//public void clickSobrePedidoProgramado() {
//		
//		if (isDisplayed(clickSobrePedidoProgramado)) {
//   		 click(clickSobrePedidoProgramado);
//   		 click(clickSobrePedidoProgramado);
//			 
//		 } else {
//			 
//			 System.out.println("No se visualiza el pedido programado tramado");
//		 }
//	}
